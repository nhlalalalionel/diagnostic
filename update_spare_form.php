...
<body>
  ...
  <div id="container">
  		<div id="tabbox">  	  			
        <a href="#" id="signin" class="tab select">SPARE</a>
  		</div>
		
  		<div id="formpanel">
  			<div id="signinbox">
  		    <form action="update_spare.php" id="signinform"method="post">
			<label for="username">Ticket #</label>
            <input type="text" name="ticket" id="name" class="txtfield" tabindex="4" autocomplete="off">
