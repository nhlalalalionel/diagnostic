...
<body>
 ...
 <div id="navigation2">
      <ul>
        <li><a href="upload_process2.php">Back</a></li>
      </ul>
    </div>
	<br>
...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(ticket) AS total FROM upload  WHERE uploader='$firstname' ";
...
$sql="SELECT * FROM upload WHERE uploader='$firstname' ORDER BY ticket ASC $limit";
...
$list = '';
?>
   <h4><a style ="color:white">DELETE FILE TABLE.</a></h4>
...
<?php
 ...
 if ($query->num_rows > 0) {
	...
	?>	
		...
		<td><a href="deletefile2.php? ticket= <?php echo $row['ticket'] ?> & myfile= <?php echo $row['filename']?>">Delete file</a> </td>
        </tr>
         <?php
    }
