...
// Get the total count of rows
  ...
  $sql = "SELECT COUNT(id) AS total FROM engineer";
...
$sql="SELECT * FROM engineer ORDER BY id ASC $limit";
...
$list = '';
?>
   <h4><a style ="color:white">ENGINEEER TABLE.</a></h4>
   <div style="overflow-x:auto;">
   <table width="100%" border="1">
   <tr>
    <td><h3>Engineer Name</h3></td>
	<td><h3>Engineer Email</h3></td>
	<td><h3>Engineer Phone</h3></td>
    <td><h3>Engineer ID</h3></td>
   </tr>
