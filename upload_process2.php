...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(ticket) AS total FROM tickets WHERE status='$status' && job_card='$x'";
...
$sql="SELECT * FROM tickets WHERE status='$status' && job_card='$x' ORDER BY ticket ASC $limit";
...
?>
   ...
   <h4><a style ="color:white">UPLOAD FILE TABLE.</a></h4>
...
<?php
 ...
 if ($query->num_rows > 0) {
	...
	?>	
		...
		<td><a href="upload_process.php?ticket= <?php echo $row['ticket'] ?>">Select</a> </td> 
        </tr>
        <?php
    }
