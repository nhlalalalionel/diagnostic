...
<body>
  ...
  <div id="navigation">
      <ul>
        <li><a href="reallocate_form.php">Back</a></li>
  ...
  <section id="maincontent">
  	<div id="container2">
  		<h4><a href="reallocate_form.php" style ="color:white">The serial number is not found in our database, please click to try again!</a></h4>
