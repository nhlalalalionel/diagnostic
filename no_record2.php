...
<body>
  ...
  <section id="maincontent">
  	<div id="container2"><br>
  		<h4 style ="color:white">This ticket number has not yet been updated since it has been logged, it is still sitting on open ticket without update.</a></h4>
		<h4 style ="color:white">Please <a href="open_ticket.php" style ="color:blue">click here</a>to check open tickets</h4>
