...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(ticket) AS total FROM tickets WHERE client_id ='$id' && dates>= '$date' && dates<= '$date2'";
...
$sql="SELECT * FROM tickets WHERE client_id ='$id' && dates>= '$date' && dates<= '$date2' ORDER BY ticket ASC $limit";
...
?>
  ...
  <form method="post" action="download_file2.php">
     <input type="submit" name="export2" class="btn btn-success" value="Download File" />
    </form>
	<br><br><br><br>
