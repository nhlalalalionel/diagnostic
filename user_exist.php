...
<body>
  <header id="header">
   <h4 style="color:white;float:left"> <?php echo "Welcome  : "  .$_SESSION['firstname']?> </h4>
  	<h1>CLIENT/MACHINE REGISTRATION</h1>
  ...
  <section id="maincontent">
  	<div id="container2">
  		<h4><a href="reg_client_form.php" style ="color:white ;padding: 0px 0px 0px 120px">User with the same email address/contact number exist, click to try again...!</a></h4>
