...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(ticket) AS total FROM tickets WHERE status ='pending'";
...
$sql = "SELECT * FROM tickets WHERE status='pending' ORDER BY ticket DESC $limit";
...
$list = '';
?>
   <h4><a style ="color:white">OPEN TICKET TABLE.</a></h4>
...
<?php
 ...
 if ($query->num_rows > 0) {
	...
	?>	
		...
		<td><a href="update_form.php?ticket= <?php echo $row['ticket'] ?>">Update ticket</a> </td> 
        </tr>
        <?php
    }
