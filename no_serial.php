...
<body>
  ...
  <div id="navigation">
      <ul>
	    <li><a href="serial_form.php">Back </a></li>
  ...
  <section id="maincontent">
  	<div id="container2">
		<h4><a href="serial_form.php" style ="color:white">The user id is not found on our database, please click to try again.</a></h4>
