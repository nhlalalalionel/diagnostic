...
<h4 style ="color:white ;padding: 40px 150px">You successfully deleted the record, please <a href="deletefile.php" style ="color:white">click here</a> to delete another file</h4>
