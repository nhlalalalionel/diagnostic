...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(ticket) AS total FROM tickets WHERE job_card='$x'";
...
$sql="SELECT * FROM tickets  WHERE job_card='$x' ORDER BY ticket ASC $limit";
...
<?php
 ...
 if ($query->num_rows > 0) {
	...
	?>	
		...
		<td><?php echo $row3['filename']?></td>
		<td><a href="downloadfile.php?download_file= <?php echo $row3['filename'] ?>">Download</a> </td> 
        </tr>
        <?php
    }
