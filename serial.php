...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(id) AS total FROM machine WHERE id ='$id'";
...
$sql="SELECT * FROM machine WHERE id ='$id' ORDER BY id ASC $limit";
...
$list = '';
?>
   <h4><a style ="color:white">SERIAL NUMBER TABLE.</a></h4>
