...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(ticket) AS total FROM tickets";
...
$sql="SELECT * FROM tickets ORDER BY ticket ASC $limit";
...
$list = '';
?>
   <h4><a style ="color:white">ALL TICKET TABLE.</a></h4>
...
<?php
 ...
 if ($query->num_rows > 0) {
	...
	$sql3 = "SELECT * FROM client WHERE id ='$client_id'";
...
?>
     ...
     <form method="post" action="export_machine.php">
     <input type="submit" name="export_machine" class="btn btn-success" value="Export" />
     </form><br><br><br>
