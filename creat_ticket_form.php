...
<body>
  ...
  <div id="navigation">
      <ul>
        ...
        <li><a href="downloads.php">User ID </a></li>
		 ...
		 <li><a href="update_spare_form.php">Spare Used</a></li>
      </ul>
    </div>
	<br>
  <section id="maincontent">
  	<div id="container">
  		<div id="tabbox">  	  			
        <a href="#" id="signin" class="tab select">CREATE TICKET</a>
      
  		</div>
  		<div id="formpanel">
  			<div id="signinbox">
			
  		    <form action="create_ticket.php" id="signinform"method="post">
