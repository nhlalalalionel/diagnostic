...
// Get the total count of rows
 ...
 $sql = "SELECT COUNT(name) AS total FROM client";
...
$limit = 'LIMIT ' .($pagenum - 1) * $page_rows .',' .$page_rows;
 ...
 $sql="SELECT * FROM client GROUP BY name ORDER by name  ASC $limit";
...
$list = '';
?>
   <h4><a style ="color:white">Please select the new client below.</a></h4>
   <div style="overflow-x:auto;">
   <table width="100%" border="1">
   <tr>
    <td><h3>Client Name</h3></td>
    <td><h3>Client Address</h3></td>
    <td><h3>Client Contact</h3></td>
	<td><h3>Select</h3></td>
   </tr>
...
<?php
 ...
 if ($query->num_rows > 0) {
	...
	?>	
		...
		<td><a href="machine_change.php?id= <?php echo $row['id'] ?>">Select</a> </td> 
        </tr>
         <?php
    }
